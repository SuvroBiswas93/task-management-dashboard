...
const TopBar = () => {
  ...
  return (
    <div className="flex gap-1 sm:flex-row sm:items-center justify-between py-4 bg-gray-50 rounded-xl p-2 w-full  sm:gap-4">
      ...
      <div className="flex items-center gap-3 sm:gap-4 flex-wrap sm:flex-nowrap">
        <button className="p-2.5 rounded-full cursor-pointer border border-gray-300 bg-white hover:bg-green-100 transition-colors">
          <Bell className="w-5 h-5 text-gray-900" />
        </button>

        <button className="p-2.5 rounded-full border cursor-pointer border-gray-300 bg-white hover:bg-green-100 transition-colors">
